...
urlpatterns = [
    ...
    url(r'^grouplist/$', views.getGroups, views.getMembers, name='getGroups'),
    #url(r'^grouplist/$', views.getMembers, name='getMembers'),
    #url(r'^grouplist2/$', views.getGroups, name='getGroups'),
